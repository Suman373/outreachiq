    ...
    return (
        <>
            ...
            <ul className="m-1 flex flex-col gap-4">
                ...
                <ListItem icon={<FaBookmark />} onClick={() => handleNavigate("saved-flows")} text={"Saved Flows"} />
                <ListItem icon={<SiGoogleanalytics />} paywall={true} text={"Analytics"} />
                <ListItem icon={<LuLogs />} paywall={true} text={"Logs"} />
                <ListItem icon={<IoIosSettings />} onClick={() => handleNavigate("settings")} text={"Settings"} />
